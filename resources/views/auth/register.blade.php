                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="phone_no" type="phone_no" class="form-control @error('street_address') is-invalid @enderror" name="phone_no" value="{{ old('street_address') }}" required autocomplete="phone_no">
